...
import kompleks from "../../assets/brand-komplex.svg";
...
const FilterPanel = () => {
  ...
  useEffect(() => {
    const handleResize = () => {
      ...
      setIsMobile(width <= 1115 && width >= 860);
      setIsTablet(width <= 870 && width >= 300);
    };
  ...
  return (
    <div className={`filter-panel-wrapper ${showMenu ? "open" : ""}`}>
     {(isMobile || isTablet) && (
        <div
      ...
      <div className={`filter-panel  ${showMenu ? "open" : ""}`}>
        <div className=" filter-panel-content w-full md:w-80 p-4 bg-white shadow-md rounded-lg space-y-6">
